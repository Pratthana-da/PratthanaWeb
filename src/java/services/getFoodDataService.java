...
public class getFoodDataService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String name = requestUrl.substring("/PratthanaWeb/getFoodDataService/".length());
        ...
        Addfood food = dbConnection.getSmoothie(name);

        if (food != null) {
            String json = "{\n";
            json += "\"name\": " + JSONObject.quote(food.getFoodname()) + ",\n";
            json += "\"type\": " + JSONObject.quote(food.getType()) + ",\n";
            json += "\"taste\": " + JSONObject.quote(Arrays.toString(food.getTaste())) + ",\n";
            json += "\"toppings\": " + JSONObject.quote(food.getToppings()) + ",\n";
